...
public class bl_GunManager : bl_MonoBehaviour
{
    ...
    // index of the weapon in the <see cref="PlayerEquip"/> list
    ...
    // The GunID of the current equipped weapon -1 means that the player doesn't have a weapon equipped yet
