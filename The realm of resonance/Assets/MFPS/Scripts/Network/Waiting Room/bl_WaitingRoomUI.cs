...
public class bl_WaitingRoomUI : bl_WaitingRoomUIBase
{
    ...
    public override void UpdateRoomInfoUI()
    {
        ...
        FriendlyFireText.text = string.Format("友方伤害: {0}", (bool)room.CustomProperties[PropertiesKeys.RoomFriendlyFire] ? "ON" : "OFF");       
        UpdatePlayerCount();
        ...
        readyButtons[1].GetComponentInChildren<TextMeshProUGUI>().text = bl_WaitingRoomBase.Instance.IsLocalReady() ? "取消".Localized(67).ToUpper() : "准备".Localized(184).ToUpper();
    ...
    public override void UpdatePlayerCount()
    {
        ...
        {
            PlayerCountText.text += $" 观战 {spectatorsCount}";
        }
    }
